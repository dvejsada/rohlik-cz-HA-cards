 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,r=Symbol(),s=new WeakMap;let n=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==r)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=s.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&s.set(e,t))}return t}toString(){return this.cssText}};const o=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,r)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[r+1],t[0]);return new n(i,t,r)},a=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new n("string"==typeof t?t:t+"",void 0,r))(e)})(t):t,{is:l,defineProperty:c,getOwnPropertyDescriptor:h,getOwnPropertyNames:d,getOwnPropertySymbols:u,getPrototypeOf:p}=Object,m=globalThis,g=m.trustedTypes,f=g?g.emptyScript:"",v=m.reactiveElementPolyfillSupport,y=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?f:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},b=(t,e)=>!l(t,e),w={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:b};
/**
 * @license
...
`,ge={cs:{title:"Příští rozvoz",chip_arriving:"Na cestě",chip_ordered:"Objednáno",chip_delivered:"Doručeno",chip_none:"Bez objednávky",chip_express:"Expres k dispozici",chip_reserved:"Rezervovaný termín",estimated:"odhad",by:"do",delivered_caption:"doručeno",nearest_slot:"Nejbližší termín",window:"Okno",order:"objednávka",announcement_updated:"Aktualizováno {time}",refresh_failed:"Obnovení se nezdařilo",no_entities:"Na tomto zařízení nebyly nalezeny entity Rohlík.cz",reserved_until:"Rezervováno do {time}",shop_link:"Objednat znovu na rohlik.cz",slot_express:"Expres",slot_standard:"Standard",slot_eco:"Eko"},en:{title:"Next delivery",chip_arriving:"Arriving",chip_ordered:"Ordered",chip_delivered:"Delivered",chip_none:"No order",chip_express:"Express available",chip_reserved:"Slot reserved",estimated:"estimated",by:"by",delivered_caption:"delivered",nearest_slot:"nearest slot",window:"Window",order:"order",announcement_updated:"Updated {time}",refresh_failed:"Refresh failed",no_entities:"Rohlík.cz entities not found on this device",reserved_until:"Reserved until {time}",shop_link:"Order again on rohlik.cz",slot_express:"Express",slot_standard:"Standard",slot_eco:"Eco"}},fe={cs:{device:"Zařízení",name:"Vlastní název",show_announcement:"Zobrazit oznámení kurýra",show_order_summary:"Zobrazit shrnutí objednávky",show_express_chip:"Zobrazit chip Expres",show_refresh:"Zobrazit tlačítko Obnovit",show_slots:"Zobrazit termíny",show_shop_link:"Odkaz na obchod",compact:"Kompaktní zobrazení"},en:{device:"Device",name:"Custom name",show_announcement:"Show courier announcement",show_order_summary:"Show order summary",show_express_chip:"Show express chip",show_refresh:"Show refresh button",show_slots:"Show upcoming slots",show_shop_link:"Show shop link",compact:"Compact layout"}},ve=[{name:"device",required:!0,selector:{device:{integration:"rohlikcz"}}},{name:"name",selector:{text:{}}},{name:"language",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (Home Assistant)"},{value:"cs",label:"Čeština"},{value:"en",label:"English"}]}}}],ye={cs:{device:"Zařízení (účet Rohlík.cz)",name:"Vlastní název",language:"Jazyk karty"},en:{device:"Device (Rohlík.cz account)",name:"Custom name",language:"Card language"}};class _e extends ct{constructor(){super(...arguments),this.defaults={},this.computeLabel=t=>{const e={};for(const t of new Set([...Object.keys(ye),...Object.keys(this.labels)]))e[t]={...ye[t],...this.labels[t]};return Ut(this.hass,e,t.name)||t.name},this.onValueChanged=t=>{t.stopPropagation();const e={...this.config,...t.detail.value};"auto"!==e.language&&""!==e.language||delete e.language;for(const[t,i]of Object.entries(this.defaults))t in e&&e[t]===i&&delete e[t];Gt(this,"config-changed",{config:e})}}setConfig(t){this.config=t}get schema(){return[...ve,...this.extraSchema()]}get formData(){return{language:"auto",...this.defaults,...this.config}}render(){return this.hass&&this.config?B`
    ...
    `}renderSlots(t){return B`<div class="slots">${t.slots.map(t=>this.renderSlotRow(t))}</div>`}renderSlotRow(t){const e=Pt(this.hass,t.start,{today:this.t("today"),tomorrow:this.t("tomorrow")}),i=0===t.price?this.t("free"):null!=t.price?Ot(this.hass,t.price):"";return B`
      <div class="slot-row">
    ...
    `}headlineMain(t){switch(t.state){case"arriving":return t.eta?It(this.hass,t.eta):t.till?It(this.hass,t.till):"—";case"ordered":return t.since?Pt(this.hass,t.since,{today:this.t("today"),tomorrow:this.t("tomorrow")}):"—";case"delivered":return t.deliveredAt?It(this.hass,t.deliveredAt):"—";default:return t.firstDeliveryText??"—"}}headlineCaption(t){switch(t.state){case"arriving":return this.t(t.eta?"estimated":"by");case"ordered":return t.since?function(t,e){const i=Ct(t),[r,s]=Tt(i,"future"),n=Math.max(0,Math.round((e.getTime()-Date.now())/1e3)),o=Math.round(n/60);if(n<60)return Mt(r,Nt(i,n,"seconds"),s);if(o<60)return Mt(r,Nt(i,o,"minutes"),s);const a=Math.floor(o/60),l=o%60;if(a<24){const t=Nt(i,a,"hours");return Mt(r,0===l?t:`${t} ${Nt(i,l,"minutes")}`,s)}return Mt(r,Nt(i,Math.round(o/60/24),"days"),s)}(this.hass,t.since):"";case"delivered":return this.t("delivered_caption");default:return this.t("nearest_slot")}}renderSub(t){if(!t.since||!t.till)return V;const e=Pt(this.hass,t.since,{today:this.t("today"),tomorrow:this.t("tomorrow")}),i=[`${this.t("window")} ${e} – ${It(this.hass,t.till)}`];return null!=t.orderId&&i.push(`${this.t("order")} ${t.orderId}`),B`${i.join(" · ")}`}renderTrack(t){if(!t.since||!t.till||null==t.progress)return V;const e=new Date((t.since.getTime()+t.till.getTime())/2);return B`
    ...
    `}value(t){switch(t.state){case"arriving":return t.eta?It(this.hass,t.eta):t.till?It(this.hass,t.till):"—";case"ordered":return t.since?Pt(this.hass,t.since,{today:this.t("today"),tomorrow:this.t("tomorrow")}):"—";case"delivered":return t.deliveredAt?It(this.hass,t.deliveredAt):"—";default:return t.firstDeliveryText??"—"}}};var Ee;ze.styles=o`
    :host {
      --rohlik-accent: var(--primary-color);
      display: inline-flex;
      max-width: 100%;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{I:Ce}=ot,Oe=t=>t,Ie=()=>document.createComment(""),Re=(t,e,i)=>{const r=t._$AA.parentNode,s=void 0===e?t._$AB:e._$AA;if(void 0===i){const e=r.insertBefore(Ie(),s),n=r.insertBefore(Ie(),s);i=new Ce(e,n,t,t.options)}else{const e=i._$AB.nextSibling,n=i._$AM,o=n!==t;if(o){let e;i._$AQ?.(t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==n._$AU&&i._$AP(e)}if(e!==s||o){let t=i._$AA;for(;t!==e;){const e=Oe(t).nextSibling;Oe(r).insertBefore(t,s),t=e}}}return i},Pe=(t,e,i=t)=>(t._$AI(e,i),t),De={},Te=(t,e=De)=>t._$AH=e,Ne=t=>{t._$AR(),t._$AA.remove()},Me=(t,e,i)=>{const r=new Map;for(let s=e;s<=i;s++)r.set(t[s],s);return r},je=yt(class extends _t{constructor(t){if(super(t),t.type!==vt)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let r;void 0===i?i=e:void 0!==e&&(r=e);const s=[],n=[];let o=0;for(const e of t)s[o]=r?r(e,o):o,n[o]=i(e,o),o++;return{values:n,keys:s}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,r]){const s=(t=>t._$AH)(t),{values:n,keys:o}=this.dt(e,i,r);if(!Array.isArray(s))return this.ut=o,n;const a=this.ut??=[],l=[];let c,h,d=0,u=s.length-1,p=0,m=n.length-1;for(;d<=u&&p<=m;)if(null===s[d])d++;else if(null===s[u])u--;else if(a[d]===o[p])l[p]=Pe(s[d],n[p]),d++,p++;else if(a[u]===o[m])l[m]=Pe(s[u],n[m]),u--,m--;else if(a[d]===o[m])l[m]=Pe(s[d],n[m]),Re(t,l[m+1],s[d]),d++,m--;else if(a[u]===o[p])l[p]=Pe(s[u],n[p]),Re(t,s[d],s[u]),u--,p++;else if(void 0===c&&(c=Me(o,p,m),h=Me(a,d,u)),c.has(a[d]))if(c.has(a[u])){const e=h.get(o[p]),i=void 0!==e?s[e]:null;if(null===i){const e=Re(t,s[d]);Pe(e,n[p]),l[p]=e}else l[p]=Pe(i,n[p]),Re(t,s[d],i),s[e]=null;p++}else Ne(s[u]),u--;else Ne(s[d]),d++;for(;p<=m;){const e=Re(t,l[m+1]);Pe(e,n[p]),l[p++]=e}for(;d<=u;){const t=s[d++];null!==t&&Ne(t)}return this.ut=o,Te(t,l),Z}}),Ue=o`
  .adding {
    display: flex;
    align-items: center;
    gap: 8px;
 ...
 */function qe(t){if(!t||"string"!=typeof t.summary)return null;const e=He.exec(t.summary.trim());if(!e)return null;const[,i,r,s]=e,n=i.trim(),o=parseInt(r,10),a=parseFloat(s.replace(",","."));if(!n||!Number.isFinite(o)||!Number.isFinite(a))return null;const l={uid:t.uid,name:n,quantity:o,price:a},{category:c,brand:h,productId:d}=function(t){const e={};if(!t)return e;for(const i of t.split(/\r?\n/)){const t=i.indexOf(":");if(-1===t)continue;const r=i.slice(0,t).trim().toLowerCase().replace(/[^a-z0-9]/g,""),s=i.slice(t+1).trim();if(s)if("category"===r)e.category=s;else if("brand"===r)e.brand=s;else if("productid"===r){const t=parseInt(s,10);Number.isFinite(t)&&(e.productId=t)}}return e}(t.description);return void 0!==c&&(l.category=c),void 0!==h&&(l.brand=h),void 0!==d&&(l.productId=d),l}const Be=/^(\d+)\s+(.+)$/,Ke=/^(.+?)\s*\((\d+)\)\s*$/;function Ze(t){const e=(t??"").trim(),i=Be.exec(e);if(i){const t=i[2].trim();if(t)return{quantity:parseInt(i[1],10),name:t}}const r=Ke.exec(e);if(r){const t=r[1].trim();if(t)return{quantity:parseInt(r[2],10),name:t}}return{quantity:1,name:e}}function Ve(t,e,i){if(i<=0)return-1;const r=t+e;return r<-1?-1:r>=i?i-1:r}let We=class extends _e{constructor(){super(...arguments),this.labels=Le,this.defaults={show_search:!0,show_brand:!0,group_by_category:!1,max_items:0,list_max_height:360,min_order:0,show_order_button:!0}}extraSchema(){return[{name:"show_search",selector:{boolean:{}}},{name:"group_by_category",selector:{boolean:{}}},{name:"show_brand",selector:{boolean:{}}},{name:"max_items",selector:{number:{min:0,max:50,mode:"box"}}},{name:"list_max_height",selector:{number:{min:0,max:2e3,step:10,mode:"box",unit_of_measurement:"px"}}},{name:"min_order",selector:{number:{min:0,max:5e3,step:10,mode:"box",unit_of_measurement:"Kč"}}},{name:"show_order_button",selector:{boolean:{}}},{name:"checkout_url",selector:{text:{}}}]}};We=t([dt("rohlik-cart-card-editor")],We);let Qe=class extends Bt{constructor(){super(...arguments),this.strings=Fe,this.lines=[],this.loading=!1,this.error=null,this.expanded=!1,this.searchQuery="",this.searchResults=[],this.searching=!1,this.searchError=null,this.searchAttempted=!1,this.favouriteOnly=!1,this.addingName=null,this.popoverOpen=!1,this.popoverRect=null,this.highlightedIndex=-1,this.pendingUids=new Set,this.reloadDeferred=!1,this.totalOverride=null,this.itemsOverride=null,this.searchSeq=0,this.loadSeq=0,this.popoverListenersAttached=!1,this.onWindowReposition=()=>{void 0===this.repositionRaf&&(this.repositionRaf=requestAnimationFrame(()=>{this.repositionRaf=void 0,this.positionPopover()}))},this.onDocumentPointerDown=t=>{t.composedPath().includes(this)||this.closePopover()},this.onSearchInput=t=>{const e=t.target.value;this.searchQuery=e,this.searchError=null,this.highlightedIndex=-1,this.searchDebounce&&clearTimeout(this.searchDebounce);const i=e.trim();if(i.length<2)return this.searchResults=[],this.searching=!1,this.searchAttempted=!1,void this.closePopover();this.openPopover(),this.searchDebounce=setTimeout(()=>{this.runSearch(i)},400)},this.onSearchFocus=()=>{this.searchQuery.trim().length>=2&&this.openPopover()},this.onSearchKeydown=t=>{if("Escape"===t.key)return this.popoverOpen&&t.preventDefault(),void this.clearSearch();if("ArrowDown"===t.key){if(!this.popoverOpen||!this.searchResults.length)return;return t.preventDefault(),void(this.highlightedIndex=Ve(this.highlightedIndex,1,this.searchResults.length))}if("ArrowUp"===t.key){if(!this.popoverOpen||!this.searchResults.length)return;return t.preventDefault(),void(this.highlightedIndex=Ve(this.highlightedIndex,-1,this.searchResults.length))}if("Enter"===t.key){t.preventDefault();const e=this.highlightedIndex>=0?this.searchResults[this.highlightedIndex]:void 0;if(e)return void this.addSearchResult(e);this.searchAndAdd()}},this.toggleFavouriteOnly=()=>{this.favouriteOnly=!this.favouriteOnly;const t=this.searchQuery.trim();t.length>=2&&this.runSearch(t)}}static getConfigElement(){return document.createElement("rohlik-cart-card-editor")}static getStubConfig(t){return{...Bt.getStubConfig(t),type:"custom:rohlik-cart-card"}}getCardSize(){return 5}getGridOptions(){return{columns:12,rows:8,min_columns:6,min_rows:4}}disconnectedCallback(){super.disconnectedCallback(),this.searchDebounce&&clearTimeout(this.searchDebounce),this.detachPopoverListeners()}attachPopoverListeners(){this.popoverListenersAttached||(this.popoverListenersAttached=!0,window.addEventListener("scroll",this.onWindowReposition,!0),window.addEventListener("resize",this.onWindowReposition),document.addEventListener("pointerdown",this.onDocumentPointerDown))}detachPopoverListeners(){this.popoverListenersAttached&&(this.popoverListenersAttached=!1,window.removeEventListener("scroll",this.onWindowReposition,!0),window.removeEventListener("resize",this.onWindowReposition),document.removeEventListener("pointerdown",this.onDocumentPointerDown),void 0!==this.repositionRaf&&(cancelAnimationFrame(this.repositionRaf),this.repositionRaf=void 0))}positionPopover(){const t=this.searchBoxEl;if(!t)return;const e=t.getBoundingClientRect();this.popoverRect={left:e.left,top:e.bottom+4,width:e.width}}openPopover(){this.attachPopoverListeners(),this.popoverOpen=!0,this.positionPopover()}closePopover(){this.detachPopoverListeners(),(this.popoverOpen||-1!==this.highlightedIndex)&&(this.popoverOpen=!1,this.highlightedIndex=-1)}willUpdate(t){if(super.willUpdate(t),!t.has("hass")||!this.hass||!this.config)return;const e=this.state("shopping_cart"),i=this.state("cart_price");if(!e||!i)return;const r=`${e.state}|${e.last_updated}|${i.state}`;r!==this.loadedKey&&(this.loadedKey=r,this.pendingUids.size>0?this.reloadDeferred=!0:this.loadItems())}sensorTotal(){const t=parseFloat(this.state("cart_price")?.state??"");return Number.isFinite(t)?t:0}sensorItems(){const t=this.attr("cart_price","Total items");return"number"==typeof t?t:this.lines.length}finishEdit(t){const e=new Set(this.pendingUids);e.delete(t),this.pendingUids=e,0===e.size&&(this.totalOverride=null,this.itemsOverride=null,this.reloadDeferred&&(this.reloadDeferred=!1,this.loadItems()))}async ensureConfigEntryId(){if(this.configEntryId)return this.configEntryId;const t=this.entityId("cart_price");return t?(this.configEntryId=await Qt(this.hass,t),this.configEntryId):void 0}async loadItems(){const t=this.entityId("shopping_cart");if(!t)return;const e=++this.loadSeq;this.loading=!0,this.error=null;try{const i=await this.hass.callWS({type:"todo/item/list",entity_id:t});if(e!==this.loadSeq)return;this.lines=(i.items??[]).map(t=>qe(t)).filter(t=>null!==t)}catch{if(e!==this.loadSeq)return;this.error=this.t("load_error")}finally{e===this.loadSeq&&(this.loading=!1)}}async removeItem(t){const e=this.entityId("shopping_cart");if(!e||this.pendingUids.has(t))return;const i=this.lines,r=this.lines.find(e=>e.uid===t);this.pendingUids=new Set(this.pendingUids).add(t),this.lines=this.lines.filter(e=>e.uid!==t),this.totalOverride=Math.max(0,(this.totalOverride??this.sensorTotal())-(r?.price??0)),this.itemsOverride=Math.max(0,(this.itemsOverride??this.sensorItems())-1),this.error=null;try{await this.hass.callService("todo","remove_item",{item:t},{entity_id:e})}catch{this.lines=i,this.error=this.t("action_error")}finally{this.finishEdit(t)}}async changeQuantity(t,e){if(this.pendingUids.has(t.uid))return;if(e<=0)return void await this.removeItem(t.uid);const i=this.entityId("shopping_cart");if(!i||void 0===t.productId)return;const r=this.lines,s=t.quantity>0?t.price/t.quantity:0,n=Math.round(s*e*100)/100;this.pendingUids=new Set(this.pendingUids).add(t.uid),this.lines=this.lines.map(i=>i.uid===t.uid?{...i,quantity:e,price:n}:i),this.totalOverride=Math.max(0,(this.totalOverride??this.sensorTotal())+(n-t.price)),this.error=null;try{await this.hass.callService("todo","remove_item",{item:t.uid},{entity_id:i});const r=await this.ensureConfigEntryId();if(!r)throw new Error("no config_entry_id for shopping_cart device");await Yt(this.hass,r,"add_to_cart",{product_id:t.productId,quantity:e})}catch{this.lines=r,this.error=this.t("action_error")}finally{this.reloadDeferred=!0,this.finishEdit(t.uid)}}async runSearch(t){const e=await this.ensureConfigEntryId();if(!e)return;const i=++this.searchSeq;this.searching=!0;try{const r=await Yt(this.hass,e,"search_product",{product_name:t,limit:8,favourite:this.favouriteOnly},!0);if(i!==this.searchSeq)return;this.searchResults=r?.search_results??[],this.highlightedIndex=-1,this.searchAttempted=!0,this.searchQuery.trim().length>=2&&this.openPopover()}catch{if(i!==this.searchSeq)return;this.searchResults=[],this.searchError=this.t("search_error"),this.searchAttempted=!0,this.searchQuery.trim().length>=2&&this.openPopover()}finally{i===this.searchSeq&&(this.searching=!1)}}async searchAndAdd(){const t=this.searchQuery.trim();if(!t)return;const e=await this.ensureConfigEntryId();if(!e)return;const{quantity:i,name:r}=Ze(t);this.clearSearch(),this.addingName=r,this.error=null;try{const t=await Yt(this.hass,e,"search_and_add_to_cart",{product_name:r,quantity:i,favourite:this.favouriteOnly},!0);if(t&&!1===t.success)return void(this.error=t.message||this.t("search_add_error"));await this.loadItems()}catch{this.error=this.t("search_add_error")}finally{this.addingName=null}}async addSearchResult(t){const e=await this.ensureConfigEntryId();if(!e)return;const{quantity:i}=Ze(this.searchQuery.trim());this.clearSearch(),this.addingName=t.name??"",this.error=null;try{await Yt(this.hass,e,"add_to_cart",{product_id:t.id,quantity:i}),await this.loadItems()}catch{this.error=this.t("search_add_error")}finally{this.addingName=null}}clearSearch(){this.searchDebounce&&clearTimeout(this.searchDebounce),this.searchQuery="",this.searchResults=[],this.searchError=null,this.searching=!1,this.searchAttempted=!1,this.closePopover()}render(){if(!this.config)return V;const t=this.entityId("shopping_cart"),e=this.entityId("cart_price");if(!t||!e)return B`<ha-card>${this.renderError(this.t("missing_entities"))}</ha-card>`;const i=this.state("cart_price"),r=this.totalOverride??(i?parseFloat(i.state):0),s=Boolean(this.attr("cart_price","Can Order")),n=this.config.min_order??0,o=Number(this.state("no_limit")?.state)>0,a=n>0&&!o&&r<n,l=this.attr("cart_price","Total items"),c=this.itemsOverride??("number"==typeof l?l:this.lines.length),h=0===this.lines.length,d=!1!==this.config.show_search,u=!1!==this.config.show_brand,p=!0===this.config.group_by_category,m=this.config.max_items??0,g=!1!==this.config.show_order_button,f=!h;return B`
      <ha-card style=${$t(this.accentStyle)}>
        ...
        ${a&&!h?B`<div class="hint minimum-hint">
              ${this.t("below_minimum_by",{amount:Ot(this.hass,n-r)})}
            </div>`:V}
    ...
    `}renderOrderButton(t){const e=function(t){const e=t?.trim();return e||"https://www.rohlik.cz/kosik"}(this.config.checkout_url);return B`
      <a
        class=${bt({btn:!0,order:!0,disabled:!t})}
        href=${t?e:V}
        target="_blank"
    ...
    `}renderSpinner(){return customElements.get("ha-circular-progress")?B`<ha-circular-progress indeterminate size="small"></ha-circular-progress>`:B`<div class="spinner"></div>`}renderSearchResult(t,e){const i=[t.brand,t.amount].filter(Boolean).join(" · "),r=e===this.highlightedIndex;return B`
      <div
        ...
        class=${bt({row:!0,"search-result":!0,highlighted:r})}
        role="option"
    ...
    `}renderLines(t,e,i){const r=i>0?i:this.lines.length,s=this.expanded?this.lines:this.lines.slice(0,r),n=this.lines.length>r,o=this.config.list_max_height??360;return B`
    ...
    `}renderLine(t,e){const i=this.pendingUids.has(t.uid),r=[t.category,e?t.brand:void 0].filter(t=>Boolean(t)).join(" · ");return B`
      <div class=${bt({row:!0,"cart-line":!0,pending:i})}>
        <div class="cell">
          <div class="name">${t.name}</div>
...
`,ii={cs:{title:"Termíny rozvozu",slot_express:"Expres",slot_standard:"Standard",slot_eco:"Eko",express_available:"Expres k dispozici",no_express:"Bez expresu",watch_toggle:"Sledovat expres",watch_error:"Aktualizace se nezdařila",no_entities:"Na tomto zařízení nebyly nalezeny entity Rohlík.cz",layout_auto:"Automaticky",layout_row:"Řádek",layout_column:"Sloupec"},en:{title:"Delivery slots",slot_express:"Express",slot_standard:"Standard",slot_eco:"Eco",express_available:"Express available",no_express:"No express",watch_toggle:"Watch express",watch_error:"Refresh failed",no_entities:"Rohlík.cz entities not found on this device",layout_auto:"Auto",layout_row:"Row",layout_column:"Column"}},ri={cs:{device:"Zařízení",name:"Vlastní název",slots:"Zobrazené sloty",layout:"Rozložení",show_price:"Zobrazit cenu",show_location:"Zobrazit adresu",watch_interval:"Interval sledování (s)"},en:{device:"Device",name:"Custom name",slots:"Slots shown",layout:"Layout",show_price:"Show price",show_location:"Show location",watch_interval:"Watch interval (s)"}};let si=class extends _e{constructor(){super(...arguments),this.labels=ri,this.defaults={slots:["express","standard","eco"],show_price:!0,show_location:!0,watch_interval:15,layout:"auto"}}extraSchema(){const t=t=>Ut(this.hass,ii,t);return[{name:"slots",selector:{select:{multiple:!0,mode:"list",options:[{value:"express",label:t("slot_express")},{value:"standard",label:t("slot_standard")},{value:"eco",label:t("slot_eco")}]}}},{name:"layout",selector:{select:{mode:"dropdown",options:[{value:"auto",label:t("layout_auto")},{value:"row",label:t("layout_row")},{value:"column",label:t("layout_column")}]}}},{name:"show_price",selector:{boolean:{}}},{name:"show_location",selector:{boolean:{}}},{name:"watch_interval",selector:{number:{mode:"box",min:10,max:300}}}]}};si=t([dt("rohlik-slots-card-editor")],si);let ni=class extends Bt{constructor(){super(...arguments),this.strings=ii,this.watching=!1,this.pollError=null,this.onVisibilityChange=()=>this.syncPolling(),this.toggleWatch=()=>{this.watching=!this.watching,this.saveWatchFlag(this.watching),this.watching&&(this.pollError=null)}}static getConfigElement(){return document.createElement("rohlik-slots-card-editor")}static getStubConfig(t){return{...Bt.getStubConfig(t),type:"custom:rohlik-slots-card"}}getGridOptions(){return"column"===this.config?.layout?{columns:4,rows:6,min_columns:3,min_rows:4}:{columns:12,rows:3,min_columns:6,min_rows:2}}setConfig(t){super.setConfig(t),this.watching=this.loadWatchFlag()}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.syncPolling()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.stopPolling()}willUpdate(t){super.willUpdate(t),this.syncPolling()}watchStorageKey(){const t=this.config?.device;return t?`rohlik-slots-watch:${t}`:null}loadWatchFlag(){const t=this.watchStorageKey();if(!t)return!1;try{return"1"===localStorage.getItem(t)}catch{return!1}}saveWatchFlag(t){const e=this.watchStorageKey();if(e)try{localStorage.setItem(e,t?"1":"0")}catch{}}syncPolling(){const t=this.watching&&"visible"===document.visibilityState&&!!this.config,e=Math.max(10,this.config?.watch_interval??15);t?void 0!==this.pollTimer&&this.pollSeconds===e||(this.stopPolling(),this.pollTimer=setInterval(()=>{this.poll()},1e3*e),this.pollSeconds=e):this.stopPolling()}stopPolling(){void 0!==this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=void 0),this.pollSeconds=void 0}async poll(){const t=this.entityId("express_slot")??this.entityId("standard_slot")??this.entityId("eco_slot");if(t&&this.hass)try{const e=await Qt(this.hass,t);if(!e)throw new Error("no config entry");await Yt(this.hass,e,"refresh_slots"),this.pollError=null}catch{this.pollError=this.t("watch_error")}}slotsToShow(){const t=this.config?.slots;return t&&t.length>0?t:Ye}render(){if(!this.config)return V;if(0===this.entities.size)return B`
      ...
      <ha-card style=${$t(this.accentStyle)}>
        <div class="header">
          ...
          <div class="header-actions">
            <button
              class=${bt({"icon-toggle":!0,on:this.watching})}
        ...
        <div
          class=${bt({"slots-grid":!0,column:"column"===s,auto:"auto"===s})}
    ...
    `}};ni.styles=[qt,ei],t([gt()],ni.prototype,"watching",void 0),t([gt()],ni.prototype,"pollError",void 0),ni=t([dt("rohlik-slots-card")],ni),Vt({type:"rohlik-slots-card",name:"Rohlík.cz Delivery Slots",description:"Express, standard and eco delivery slot times, prices and remaining capacity.",preview:!0});const oi=o`
  :host {
    container-type: inline-size;
...
`,Si={cs:{month:"Tento měsíc",year:"Letos",all:"Celkem"},en:{month:"This month",year:"This year",all:"All time"}},Ai={cs:{l0:"Hlavní",l1:"Kategorie",l2:"Podrobné",l3:"Nejpodrobnější",items:"Položky"},en:{l0:"Top",l1:"Categories",l2:"Detailed",l3:"Specific",items:"Items"}},zi={cs:{auto:"Automaticky",years:"Roky",months:"Měsíce",none:"Žádný"},en:{auto:"Automatic",years:"Years",months:"Months",none:"None"}};let Ei=class extends _e{constructor(){super(...arguments),this.labels=$i,this.defaults={default_period:"year",default_level:"l1",top_n:10,chart:"auto",show_totals:!0}}extraSchema(){return[{name:"default_period",selector:{select:{mode:"dropdown",options:mi.map(t=>({value:t,label:Ut(this.hass,Si,t)}))}}},{name:"default_level",selector:{select:{mode:"dropdown",options:pi.map(t=>({value:t,label:Ut(this.hass,Ai,t)}))}}},{name:"top_n",selector:{number:{min:1,max:50,mode:"box"}}},{name:"chart",selector:{select:{mode:"dropdown",options:gi.map(t=>({value:t,label:Ut(this.hass,zi,t)}))}}},{name:"show_totals",selector:{boolean:{}}}]}};Ei=t([dt("rohlik-spending-card-editor")],Ei);let Ci=class extends Bt{constructor(){super(...arguments),this.strings=xi,this.expanded=new Set,this.monthlyError=!1,this.hasSensor=t=>void 0!==this.entityId(t)}static getConfigElement(){return document.createElement("rohlik-spending-card-editor")}static getStubConfig(t){return{...Bt.getStubConfig(t),type:"custom:rohlik-spending-card"}}getCardSize(){return 6}getGridOptions(){return{columns:12,rows:12,min_columns:6,min_rows:5}}get effectivePeriod(){return this.period??this.config?.default_period??"year"}resolveChart(t){const e=this.config?.chart??"auto";return"auto"!==e?e:!1===this.config?.show_years?"none":"month"===t?"months":"years"}get levelsForCurrentPeriod(){return t=this.hasSensor,e=fi(this.effectivePeriod),pi.filter(i=>t(yi(i,e)));var t,e}get hasAnyAnalytics(){return pi.some(t=>this.hasSensor(yi(t,"year"))||this.hasSensor(yi(t,"all")))}get effectiveLevel(){const t=this.levelsForCurrentPeriod;if(0===t.length)return;const e=this.level??this.config?.default_level??"l1";return t.includes(e)?e:t[0]}render(){if(!this.config)return V;if(!this.state("monthly_spent"))return B`<ha-card style=${$t(this.accentStyle)}>
      ...
      <ha-card style=${$t(this.accentStyle)}>
        <div class="header">
          ...
          <div class="segmented">
            <button
              class=${bt({pill:!0,active:"month"===t})}
              type="button"
    ...
    `}updated(t){super.updated(t),this.maybeFetchMonthly()}maybeFetchMonthly(){if(!this.config||!this.hass)return;if("months"!==this.resolveChart(this.effectivePeriod))return;const t=this.entityId("monthly_spent");if(!t)return;const e=new Date,i=`${e.getFullYear()}-${e.getMonth()}`,r=`${t}:${i}`;if(this.monthlyFetchKey===r)return;this.monthlyFetchKey=r;const s=new Date(e.getFullYear(),e.getMonth()-11,1);this.hass.callWS({type:"recorder/statistics_during_period",start_time:s.toISOString(),end_time:e.toISOString(),statistic_ids:[t],period:"month",units:{},types:["state"]}).then(e=>{this.monthly={entityId:t,monthKey:i,stats:bi(e,t)},this.monthlyError=!1}).catch(()=>{this.monthlyError=!0})}renderTotals(t){const e=this.state("monthly_spent"),i=Number(e?.state),r=new Intl.DateTimeFormat(Ct(this.hass),"month"===t?{month:"long",year:"numeric"}:{month:"long"}).format(new Date),s=this.state("yearly_spent"),n=Number(s?.state),o=s?.attributes?.year,a=Number(s?.attributes?.order_count??0),l=void 0!==o?`${o} · ${this.t("orders_count",{n:a})}`:this.t("orders_count",{n:a});let c,h;if("year"===t)c=Number(s?.attributes?.average_order_value),h=this.t("avg_order");else{const t=this.state("alltime_spent");c=Number(t?.attributes?.average_order_value);const e=Number(t?.attributes?.order_count??0);h=this.t("orders_count",{n:e})}return B`
      <div class="totals">
        ...
        <div class="totals-cell">
          <div class="totals-value">
            ${Number.isFinite(n)?Ot(this.hass,n):"–"}
          </div>
    ...
    `}renderBreakdown(t){if(!this.hasAnyAnalytics)return B`<div class="breakdown-hint">${this.t("enable_hint")}</div>`;const e=fi(t),i=this.levelsForCurrentPeriod,r=this.effectiveLevel;if(!r)return V;const s=this.config.top_n??10,n=this.state(yi(r,e)),{entries:o,enrichedOrders:a,totalOrders:l}=function(t,e){const i=t?.attributes??{},r=i.categories??i.items,s=Array.isArray(r)?r:[],n=[];for(const t of s){if(!t||"object"!=typeof t)continue;const e=t,i="string"==typeof e.name&&""!==e.name.trim()?e.name:void 0,r=_i(e.spent);i&&void 0!==r&&n.push({name:i,spent:r,units:_i(e.units)??0,avgUnitPrice:_i(e.avg_unit_price)??0,id:"string"==typeof e.id||"number"==typeof e.id?e.id:void 0})}n.sort((t,e)=>e.spent-t.spent);const o=_i(i.total_count)??n.length,a=_i(i.enriched_orders),l=_i(i.total_orders);return{entries:n.slice(0,Math.max(0,e)),totalCount:o,enrichedOrders:a,totalOrders:l}}(n,s),c=function(t){const e=t.reduce((t,e)=>Math.max(t,e.spent),0);return e<=0?t.map(()=>0):t.map(t=>Math.max(0,Math.min(100,t.spent/e*100)))}(o),h=this.state("yearly_spent")?.attributes?.year??(new Date).getFullYear();return B`
